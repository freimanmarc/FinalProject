...
Career.create(title: "Construction", description: "Getting to watch something go from sketches on a page to a fully functioning building is an exciting part of working in Construction. You will get to work with your hands and breathe in the fresh air during a typical day in this career.", starting_salary: 30000, potential_salary: 62000, education: "Entry level requires high school diploma or GED",)
Career.create(title: "Electrician", description: "Putting together all the pieces to watch something connect and run is a fun bonus to being an Electrician. Some of the abilities you will gain from your education are - diagnose, test, and debug complex equipment, program, modify, and audit prgrammable logic controllers (PLCs), create and audit maintenance tasks, procedures and logs, maintain documentation of downtime and repairs, Build and implement improvement and fixes, AC/DC power sources, AC/DC motors, motor controls, transformers, over-current protection and grounding, industrial power distribution sytems, preventative and corrective maintenance, electrical Test Equipment, Hydrolic and Pneumatic Systems, Process Control Systems, Instumentation Drawings, Technical Reporting, Employability Skills and Safety", starting_salary: 40000, potential_salary: 90500, education: "20 months full time at Miami Lakes Education Center & Technical College",)
...
Career.create(title: "Welding", description: "Getting to create things with a seemingly unworkable medium and build things from nothing is an exciting aspect of Welding. You will learn from a mixure of studying theory as well as on the job training and hands-on experience.", starting_salary: 30000, potential_salary: 45000, education: "48 months full time at Miami Dade College",)
